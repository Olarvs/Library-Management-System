...
namespace LibrarySystem
{
    public partial class frmBorrower : Form
    {
        ...
        { 
            if (MessageBox.Show("Are you sure you want to archive this borrower?", "Archive", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes) { 
        ...
        private void dtg_ABorrowLists_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        {
            if (MessageBox.Show("Are you sure you want to unarchive this borrower?", "Unarchive", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {
                sql = "UPDATE `tblborrower` SET  `Stats` =  'Active' WHERE `BorrowerId` ='" + dtg_ABorrowLists.CurrentRow.Cells[1].Value + "'";
                config.Execute_Query(sql);

                MessageBox.Show("Borrower has been unarchive in the database.", "Success", MessageBoxButtons.OK);
                btn_New_Click(sender, e);
            }
        }
        ...
        private void btn_delete_Click_1(object sender, EventArgs e)
        {
            if (MessageBox.Show("Are you sure you want to archive this borrower?", "Archive", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {
                ...
                MessageBox.Show("Borrower has been in the archive.", "Success", MessageBoxButtons.OK);
                btn_New_Click(sender, e);
            }
        }
